            ...
            if ans:
                ...
                if returnCode > 127 and exceptionCode == 0x01:
                    ...
                    if function_code_name.get(i) != None:
                        ...
                        self.printLine(
                            "[+] Function Code " + str(i) + " is supported.",
                            bcolors.OKGREEN,
                        )

            else:
                self.printLine(
                    "[+] Function Code " + str(i) + " probably supported.",
                    bcolors.OKGREEN,
                )
